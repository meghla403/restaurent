...
<body style="background-color: lavender">
    <form action="managersearch.php" method="post">
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql="select * from manager where MGR_ID='$n'";

                $result = $con->query($sql);

            if ($result->num_rows > 0) {
            echo "<br><br><br><br><table><tr><th>MGR_ID</th><th>NAME</th><th>ADDRESS</th><th>SALARY</th></tr>";
