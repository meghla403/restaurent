...
<body style="background-color: lavender">
	<form action="categoriessearch.php" method="post">
...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	$sql="select * from categories where CATEGORIES_ID='$n'";

				$result = $con->query($sql);

			if ($result->num_rows > 0) {
		    echo "<br><br><br><br><table><tr><th>CATEGORIES_ID</th><th>CATEGORIES_DESC</th></tr>";
